...
Vue.component('mba-component', require('./components/MbaComponent.vue').default);
Vue.component('concept-component', require('./components/ConceptComponent.vue').default);
